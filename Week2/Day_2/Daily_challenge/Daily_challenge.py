...
(e.g. there are only 5 total pages, but p.goToPage(10) is given: the p.currentPage should be set to 5; 
if 0 or a negative number is given, p.currentPage should be set to 1)."""
...
class Pagination:
    ...
    def goToPage(self, pageNum: int):
        if pageNum <= 0 or pageNum > self.total_pages:
            raise ValueError(
