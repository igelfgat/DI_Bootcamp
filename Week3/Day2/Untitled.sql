...
--select film_id, title, description, length, rental_rate from film where title ilike 'Favorite movie';
...
--select title, rental_rate from film order by rental_rate OFFSET 9 ROWS FETCH NEXT 10 ROWS ONLY;
...
select c.customer_id, first_name, last_name, amount, payment_date, staff_id from customer c
